...
const TopBar = () => {
  const phone = useContentValue("topbar", "phone", "(11) 99999-9999");
  const email = useContentValue("topbar", "email", "contato@nomade.com.br");
  const facebookUrl = useContentValue("topbar", "facebook_url", "");
  const facebookVisible = useContentValue("topbar", "facebook_visible", "true");
  const instagramUrl = useContentValue("topbar", "instagram_url", "");
